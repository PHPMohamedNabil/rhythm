...
class UserPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $login, User $user)
    {
      return $this->getUserAccess('can-delete') && $user->id !== auth()->user()->id;
    }
    ...
    {
       return isset(auth()->user()->role->permission->permissions['users'][$permission]);
    }
}
